...
### Higgs Bundles Day -- Lucas Castello Branco -- Gaiotto Lagrangians 
...
has three connected components $L_{-1,c}$, $L_{+1}$, $L_{-1,n}$.
...
The connected component $L_{-1,c}$ is known to be contractible.
We construct maps from $L_{+1}$ and $L_{-1,n}$
...
### July 5 -- **Alex Gomez** -- [Mordell-Weil theorem](https://en.wikipedia.org/wiki/Mordell–Weil_theorem)
...
focusing on two joint works with Jake Fillman and Wencai Liu:
- Algebraic Properties of the Fermi Variety for Periodic Graph Operators, [2305.06471](https://arxiv.org/abs/2305.06471)
- Irreducibility of the Bloch Variety for Finite-Range Schrödinger Operators, [2107.06447](https://arxiv.org/abs/2107.06447)
...
## 2022, Dec 16: [**Marcos Craizer**](http://mat.puc-rio.br/~craizer): Esferas Afins Impróprias e Equações de Monge-Ampère
...
- UFF: [Algebraic and Complex Geometry](https://sites.google.com/view/geoalgcompluff/home), [Geometry & Topology](https://sites.google.com/view/seminario-gt-uff/home)
